...
const REPORTS = [
  {
    ...
    description:
      "Consulta y gestiona las fallas reportadas en habitaciones por hotel.",
    enabled: true,
  },
  {
    name: "Dashboard de Inspecciones",
    path: "",
    external_path: "https://ms.c10.pro/",
    description:
      "Visualiza el estado de las inspecciones con gráficos y métricas clave.",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
        {REPORTS.map((report) =>
          report.enabled ? (
            <Link
              key={report.name}
              href={report.path || report.external_path || "#"}
