...
export const getAuditorias = async (fallas: string[], states: string[]) => {
    toast.loading("Obteniendo inspecciones...", {
        style: {
            background: "#000",
            color: "#fff",
            border: 'none'
    ...
    try {
        ...
        toast.dismiss();
        toast.success("Inspecciones obtenidas correctamente.", {
            style: {
                background: "#000",
                color: "#fff",
                border: 'none'
        ...
        toast.dismiss();
        toast.error(`${error}` || "Hubo un error al obtener las inspecciones.", {
            style: {
                background: "#000",
                color: "#fff",
                border: 'none'
...
export const getAuditoriaById = async (id: string) => {
    toast.loading("Obteniendo inspección...", {
        style: {
            background: "#000",
            color: "#fff",
            border: 'none'
    ...
    try {
        ...
        toast.dismiss();
        toast.success("Inspección obtenida correctamente.", {
            style: {
                background: "#000",
                color: "#fff",
                border: 'none'
