	...
	if (isLoading || isReportLoading) {
		return (
			<div className="flex justify-center items-center h-40 text-gray-400">
				Cargando reporte de inspecciones...
			</div>
		);
	}
								...
								<TabsContent value="acciones">
									<div className="flex items-center justify-center h-96">
										<div className="flex flex-col items-center justify-center h-full text-center gap-4">
											<div className="flex items-center justify-center w-20 h-20 rounded-full bg-gray-100 text-gray-500">
												<X className="w-10 h-10" />
											</div>
											<h3 className="text-2xl font-semibold text-gray-700">Módulo no habilitado</h3>
