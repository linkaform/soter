...
import { useGroupedItems } from "@/app/dashboard/inspecciones/hooks/useGroupedItems";
import Portal from "@/app/dashboard/inspecciones/components/Portal";
    ...
    const renderItem = (item: any, idx: number) => {
        ...
        return (
            <div
                ...
                className={`cols-span-2 ${itemSize} flex items-center justify-center text-sm font-medium rounded cursor-pointer ${statusClass} ${selectedClass} ${expandedClass} transition-all duration-300 hover:scale-105 relative overflow-visible`}
