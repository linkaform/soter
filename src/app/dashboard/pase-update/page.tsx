...
const PaseUpdate = () =>{
	...
	const formattedData = {
			...
			nombre:(dataCatalogos as NonNullable<typeof dataCatalogos>)? dataCatalogos?.pass_selected?.nombre||"" :"",
			ubicacion:(dataCatalogos as NonNullable<typeof dataCatalogos>) ? dataCatalogos?.pass_selected?.ubicacion||"":"",
			email:(dataCatalogos as NonNullable<typeof dataCatalogos>) ? dataCatalogos?.pass_selected?.email||"":"",
			telefono:(dataCatalogos as NonNullable<typeof dataCatalogos>) ?dataCatalogos?.pass_selected?.telefono||"":""
	};
