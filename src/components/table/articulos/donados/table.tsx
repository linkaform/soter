...
import { ArticuloDonado, donadosColumns } from "./donados-columns";





const data: ArticuloDonado[] = [
    {
          id: "1",
          nombre: "Caseta 2 - dro",
          articulo: "Neceser",
          fotografia: "/image/articulo4.png",
          color: "Negro",
...
export function ArticulosDonadosTable() {
