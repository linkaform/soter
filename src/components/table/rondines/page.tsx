...
import { Ban, CarFront, ChevronDown, Edit, Eye, FileX2, Flag, Hammer, IdCard, List, LogOut, User } from "lucide-react";
...
export const data: Recorrido[] = [
  ...
  export const columns: ColumnDef<Recorrido>[] = [
    {
      id: "options",
      header: "Opciones",
      cell: ({ row }) => (
